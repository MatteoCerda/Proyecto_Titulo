...
@Component({
  standalone: true,
  selector: 'app-admin-reporte-productos-top',
  ...
  template: `
    <ion-content class="ion-padding">
      ...
      <section class="detail-grid" *ngIf="!loading(); else loadingTpl">
        ...
        <div class="info">
          <h1>Top 10 productos del mes</h1>
          <p>
            Ranking de productos con mayor cantidad solicitada durante el mes actual. Incluimos las unidades totalizadas y
            el monto estimado asociado.
          </p>
...
export class AdminReporteProductosTopPage implements AfterViewInit, OnDestroy {
  ...
  async exportPng(): Promise<void> {
    ...
    link.href = dataUrl;
    link.download = 'top-productos.png';
    link.click();
  }
  ...
  async exportPdf(): Promise<void> {
    ...
    try {
      ...
      pdf.setFontSize(12);
      pdf.text('Top 10 productos del mes', margin, margin - 14);
      pdf.save('reporte-top-productos.pdf');
    } catch (error) {
  ...
  private async load(): Promise<void> {
    ...
    try {
      ...
      this.products.set(overview.topProducts);
      setTimeout(() => this.renderChart(), 0);
    } catch (error) {
      console.error('No se pudo cargar el reporte de productos top', error);
